...
export default function SCMCaseCreation({ onNavigate } = {}) {
  ...
  const resetFilters = () => {
    setFilters({ markStatus: "Marked", entityType: "", scoreMin: "", scoreMax: "", dateFrom: "", dateTo: "" });
                ...
                <thead>
                  <tr style={{ background: "#F8FAFC" }}>
                    ...
                    {[
                      ...
                      { key: "triggerRule", label: "Tetikleyici Kural" },
                  ...
                  <tr style={{ background: "#F8FAFC" }}>
                    ...
                    <th style={colSearchTh}>
                      <input type="text" placeholder="Ara..." value={colSearch.triggerRule}
                        onChange={e => { setColSearch(s => ({ ...s, triggerRule: e.target.value })); setPage(1); }}
                        style={colSearchInput} />
                    </th>
                    <th style={colSearchTh}>
                  ...
                  {paged.map(t => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ ...tdStyle, fontFamily: "'JetBrains Mono', monospace", fontSize: 11.5, color: C.primaryLight }}>
                          {t.triggerRule}
                        </td>
                        <td style={tdStyle}>
                          <span style={{
