...
const Icons = {
  ...
  TransactionSearch: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/><line x1="11" y1="8" x2="11" y2="14"/></svg>,
};
    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "'DM Sans', 'Segoe UI', -apple-system, sans-serif", background: C.bg, color: C.text, overflow: "hidden" }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: sidebarCollapsed ? "12px 8px" : "12px 14px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: sidebarCollapsed ? "center" : "flex-start", gap: 8, marginBottom: 10 }}>
            ...
            {!sidebarCollapsed && (
              <>
                <button style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 6, padding: 6, cursor: "pointer", color: "#94A3B8", display: "flex" }}><Icons.Globe /></button>
          ...
          {!sidebarCollapsed && (
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 4px" }}>
              <div style={{ width: 32, height: 32, borderRadius: 8, background: "linear-gradient(135deg, #F59E0B, #D97706)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 12, fontWeight: 700 }}>
                {currentUser.name.split(" ").map(n => n[0]).join("")}
              </div>
              <div>
                <div style={{ color: "#E2E8F0", fontSize: 12.5, fontWeight: 600 }}>{currentUser.name}</div>
